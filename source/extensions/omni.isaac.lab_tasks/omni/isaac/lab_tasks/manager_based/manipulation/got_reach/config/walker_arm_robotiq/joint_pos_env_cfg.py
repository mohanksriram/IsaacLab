...
from omni.isaac.lab_assets.got_reach_robotiq import WALKER_ARM_ROBOTIQ_CFG  # isort: skip
...
class WalkerArmRobotiqGOTReachEnvCfg(GOTReachEnvCfg):
    def __post_init__(self):
        ...
        self.actions.finger_joint_pos = mdp.BinaryJointVelocityActionCfg(
            asset_name="robot",
            joint_names=["left_outer_knuckle_joint_2", "right_outer_knuckle_joint_2"],
            open_command_expr={"left_outer_knuckle_joint_2": 0.0, "right_outer_knuckle_joint_2": 0.0},
            # close_command_expr={"finger_joint_2": -80.0, "right_outer_knuckle_joint_2": -80.0},
            # open_command_expr={"finger_joint_2": -80.0, "right_outer_knuckle_joint_2": -80.0},
            # open_command_expr={"finger_joint_2": 80.0, "right_outer_knuckle_joint_2": 80.0},
            close_command_expr={"left_outer_knuckle_joint_2": 50.0, "right_outer_knuckle_joint_2": -50.0},
        )
        ...
        self.scene.ee_frame = FrameTransformerCfg(
            prim_path="{ENV_REGEX_NS}/Robot/arm2/actuator2/RobotBase_Link_2",
            # prim_path="{ENV_REGEX_NS}/Robot/arm1/actuator/robot_base_link",
            debug_vis=False,
            visualizer_cfg=marker_cfg,
            target_frames=[
                FrameTransformerCfg.FrameCfg(
                    prim_path="{ENV_REGEX_NS}/Robot/arm2/gripper2/RobotiqBase_Link_2",
                    name="end_effector",
                    offset=OffsetCfg(
                        # pos=[0.0, 0.0, 0.1034],
                        # pos=[0.0, 0.0, 0.166],
