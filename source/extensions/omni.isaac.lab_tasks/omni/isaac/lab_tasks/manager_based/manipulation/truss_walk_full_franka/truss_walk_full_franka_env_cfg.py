...
class SpaceSceneCfg(InteractiveSceneCfg):
    ...
    truss = AssetBaseCfg(
        ...
        init_state=AssetBaseCfg.InitialStateCfg(pos=(-0.5, -.9, -1.7),),
        #    spawn=UsdFileCfg(usd_path=f"/home/mohan/Downloads/2F-85/truss_cube_simplified.usd",
           spawn=UsdFileCfg(usd_path=f"/home/mohan/Downloads/2F-85/truss_cube_bc.usd",
    ...
    contact_forces = ContactSensorCfg(
        prim_path="{ENV_REGEX_NS}/Robot/leg2/franka2/panda2_.*finger", update_period=0.0, history_length=3, debug_vis=False,
    )
##
# MDP settings
##
...
class ActionsCfg:
    ...
    left_body_joint_pos: mdp.JointPositionActionCfg = MISSING
    left_finger_joint_pos: mdp.BinaryJointPositionActionCfg = MISSING
    right_body_joint_pos: mdp.JointPositionActionCfg = MISSING
...
@configclass
class TrussWalkerEnvCfg(ManagerBasedRLEnvCfg):
