...
"""Configuration for the Walker robot.

The following configurations are available:

* :obj:`WALKER_CFG`: Walker robot with Robotiq hand
...
WALKER_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/mohan/Downloads/I2A-space-model-dump/model-dump/Collected_Walker_rev2/Walker_rev2.usd",
